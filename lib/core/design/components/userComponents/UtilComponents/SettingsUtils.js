...
const ImagesContext_1 = require("../../../../../context/ImagesContext");
...
function MediaAccordion({ props, setProp, src, type, isImage = false }) {
    const imagesContext = (0, react_1.useContext)(ImagesContext_1.ImagesContext);
    (0, react_1.useEffect)(() => {
    ...
    return (react_1.default.createElement(Accordion_1.CustomAccordion, { defaultExpanded: null, title: "Media", preview: react_1.default.createElement(core_3.Tooltip, { title: props.props.src },
            ...
            (imagesContext && isImage) && (react_1.default.createElement(core_1.Box, { m: 1 },
                react_1.default.createElement(core_1.Button, { variant: "contained", color: "primary", onClick: () => imagesContext.setOpenImageManager(true) }, "Open Images Manager"))),
            react_1.default.createElement(core_1.Box, { m: 1 },
