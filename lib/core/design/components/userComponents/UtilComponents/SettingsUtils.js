...
function PaddingAccordion({ props, setProp, styleProp }) {
...
function MarginAccordion({ props, setProp, styleProp }) {
...
function BorderAccordion({ props, setProp, styleProp }) {
    var borderString = props[styleProp].borderRight +
