...
function Columns({ type, handleColumns, props }) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        cnfOpen && (react_1.default.createElement(ConfirmationDialog_1.ConfirmationDialog, { onYes: () => {
                ...
                setCnfOpen(false);
            }, title: "Change Columns", content: cnfContent, yesLabel: "", noLabel: "" }))));
}
const ContainerSettings = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(UtilComponents_1.CustomAccordion, { defaultExpanded: null, title: "Columns", preview: react_1.default.createElement(core_2.Box, { px: 1, bgcolor: "#f1f1f1", borderRadius: 5 },
        ...
        props.props.containerType > 1 && (react_1.default.createElement(UtilComponents_1.CustomAccordion, { preview: {}, defaultExpanded: true, title: "Column Properties", children: react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(ResizerSettings_1.ResizerSettings, { isParent: false, id: getNodeId(tabValue) })) })),
