...
function RightPanel(_a) {
    ...
    const { actions, query, selected, rootNode } = (0, core_1.useEditor)((state, query) => {
        // const currentNodeId = state.events.selected as unknown as string;
    ...
    return (react_1.default.createElement(core_2.Box, { pb: 2, mt: 1 },
        ...
        react_1.default.createElement("div", { className: classes.settings }, selected && selected.settings ? (react_1.default.createElement(selected.settings)) : (react_1.default.createElement(react_1.default.Fragment, null, BodySettings)))));
}
