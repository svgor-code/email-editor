...
function EmailEditor() {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(EmailEditor_1.EmailEditor, { loadState: state ? state['json'] : '', loadVersion: state ? state['version'] : '', triggerFetchState: triggerFetchState, getState: getState, onPreviewOpen: handlePreviewOpen, onHtmlOpen: handleHtmlOpen }),
