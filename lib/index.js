...
exports.AppContextProvider = exports.EmailEditorComponent = void 0;
...
const EmailEditorComponent = ({ editorSsrUrl }) => {
    ...
    const appContext = (0, react_1.useContext)(AppContext_1.default);
    ...
    return (react_1.default.createElement(SettingsContext_1.SettingsProvider, { settings: settings },
        react_1.default.createElement(EmailEditor_1.EmailEditor, { loadState: appContext.editorState ? appContext.editorState['json'] : '', loadVersion: appContext.editorState ? appContext.editorState['version'] : '', triggerFetchState: triggerFetchState, getState: getState, onPreviewOpen: handlePreviewOpen, onHtmlOpen: handleHtmlOpen, editorSsrUrl: editorSsrUrl }),
