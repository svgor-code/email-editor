...
function Border({ propKey, propName, setProp, props, styleProp }) {
    ...
    const tmp = (_a = props[styleProp]) === null || _a === void 0 ? void 0 : _a[propKey];
...
function BorderComponent({ props, setProp, styleProp = 'style' }) {
    var _a;
    const classes = useStyles();
    ...
    let radius = (_a = props[styleProp]) === null || _a === void 0 ? void 0 : _a.borderRadius;
