...
const exportHtmlRepo_1 = require("../repo/exportHtmlRepo");
...
function EmailEditor(_a) {
    var { loadState, loadVersion, triggerFetchState, getState, onPreviewOpen, onHtmlOpen, editorSsrUrl } = _a, rest = __rest(_a, ["loadState", "loadVersion", "triggerFetchState", "getState", "onPreviewOpen", "onHtmlOpen", "editorSsrUrl"]);
    const classes = useStyles();
    const { settings } = (0, react_1.useContext)(SettingsContext_1.default);
    const generateClassName = (0, core_2.createGenerateClassName)({
    ...
    return (react_1.default.createElement(core_3.ThemeProvider, { theme: (0, theme_1.createTheme)(settings) },
        react_1.default.createElement(core_3.StylesProvider, { injectFirst: true, generateClassName: generateClassName },
            react_1.default.createElement(core_2.Grid, { container: true, justifyContent: "center", alignContent: "center" },
                react_1.default.createElement(core_2.Grid, { item: true, xs: 12 },
                    ...
                    react_1.default.createElement(EditorSaveModule, { triggerFetchState: triggerFetchState, getState: getState, version: loadVersion, editorSsrUrl: editorSsrUrl }))))));
}
exports.EmailEditor = EmailEditor;
function EditorSaveModule({ triggerFetchState, getState, version, editorSsrUrl, }) {
    const { query } = (0, core_1.useEditor)();
    const fetchState = () => __awaiter(this, void 0, void 0, function* () {
        const json = query.serialize();
        const state = (0, encryptJson_1.encodeJson)(JSON.stringify({ json: json, version: version }));
        let html = null;
        try {
            const craftNodes = JSON.parse(json);
            html = yield (0, exportHtmlRepo_1.renderHtml)(craftNodes, editorSsrUrl);
        }
        catch (err) {
            console.log(err);
        }
